users = User.create!([
                       { first_name: 'Mike', last_name: 'Tison', email: 'az.ramaz@yandex.ru', password: '1234567shamilek', type: 'Admin'}
                      #  { first_name: 'Azi', last_name: 'Az', email: 'aziev.kadina@yandex.ru', password: 'komsomolsknaamu', type: 'Admin'}
                     ])
